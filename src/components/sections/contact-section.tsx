        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Регистрация на платформе</p>
            </div>
            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                <div className="mb-2 font-mono text-xs text-foreground/60">Кто вы?</div>
              ...
              >
                {["Telegram", "VK", "LinkedIn"].map((social) => (
                  <a
                    key={social}
                    href="#"
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div
                ...
                style={{ transitionDelay: "500ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Сообщение (необязательно)</label>
                <textarea
                  rows={3}
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Заявка принята! Скоро свяжемся.</p>
                )}
              </div>
            </form>
          </div>
